...
// 失物招领
@Controller
@RequestMapping("/admin/lost_and_found")
public class LostAndFoundController {
    private static final String collectionName = "shiwu";
    ...
    public String index()
    {
        return "/admin/lost_and_found/index";
    }
    ...
    public JsonResult list(@RequestParam(value = "content",required = false) String content ) throws WxErrorException {
        ...
        if (content.isEmpty()){
            ...
            jsonArray = Query.where(collectionName,"name",content);
        }
