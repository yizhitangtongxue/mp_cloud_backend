...
// 上门维修
@Controller
@RequestMapping("/admin/onsite_repair")
public class OnsiteRepairController {
    private static final String collectionName = "weixiu";
    ...
    public String index()
    {
        return "/admin/onsite_repair/index";
    }
